...
void GameCore::SetScene() {
  ...
  AddObstacle<obstacle::Block>(glm::vec2{3.0f, -4.0f});
  AddObstacle<obstacle::Block>(glm::vec2{6.0f, 8.0f});
  AddObstacle<obstacle::River>(glm::vec2{3.0f, 0.0f});
  AddObstacle<obstacle::River>(glm::vec2{0.0f, -6.0f});
  AddObstacle<obstacle::River>(glm::vec2{-6.0f, 8.0f});
  AddObstacle<obstacle::Bramble>(glm::vec2{-3.0f, -4.0f});
  AddObstacle<obstacle::Bramble>(glm::vec2{0.0f, 6.0f});
  AddObstacle<obstacle::Bramble>(glm::vec2{6.0f, -8.0f});
  AddObstacle<obstacle::Brick>(glm::vec2{-3.0f, 0.0f});
  AddObstacle<obstacle::Brick>(glm::vec2{6.0f, 4.0f});
  AddObstacle<obstacle::Brick>(glm::vec2{6.0f, -4.0f});
  AddObstacle<obstacle::Brick>(glm::vec2{-6.0f, -8.0f});
  AddObstacle<obstacle::Brick>(glm::vec2{6.0f, 0.0f});
